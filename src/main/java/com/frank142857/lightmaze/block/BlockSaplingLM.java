...
import com.frank142857.lightmaze.world.gen.WorldGenSilverTree;
...
public class BlockSaplingLM extends BlockBush implements IGrowable, IHasModel {
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);
    protected static final AxisAlignedBB SAPLING_AABB = new AxisAlignedBB(0.09999999403953552D, 0.0D, 0.09999999403953552D, 0.8999999761581421D, 0.800000011920929D, 0.8999999761581421D);

    //private final String name = "silver_sapling";

    public BlockSaplingLM(String name){
        this.setRegistryName(name);
        this.setUnlocalizedName(name);
        BlockInit.REGISTER_BLOCKS.add(this);
        ItemInit.REGISTER_ITEMS.add(new ItemBlock(this).setRegistryName(name));
        setCreativeTab(CreativeTabInit.TAB_LM);
        setHardness(0.0F);
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (this == BlockInit.SILVER_SAPLING) {
            WorldGenerator worldgenerator = new WorldGenSilverTree(true, true);
