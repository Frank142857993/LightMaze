...
import com.frank142857.lightmaze.world.gen.WorldGenFlowerLM;
...
public class BiomeDecoratorLM extends BiomeDecorator {
    public WorldGenFlowerLM flowerGen = new WorldGenFlowerLM(BlockInit.FLUORESCENT_FLOWER_RED);
        ...
        if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, random, forgeChunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.FLOWERS))
            for (int l2 = 0; l2 < this.flowersPerChunk; ++l2)
            {
                ...
                if (j14 > 0)
                {
                    ...
                    // Pick Random Flower
                    BlockFlowerLM flower = BlockInit.FLUORESCENT_FLOWER_RED;
