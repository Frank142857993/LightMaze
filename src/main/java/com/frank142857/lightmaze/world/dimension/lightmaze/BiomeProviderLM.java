...
public class BiomeProviderLM extends BiomeProvider {
    private GenLayer genBiomes;
    private GenLayer biomeIndexLayer;
    private BiomeCache biomeCache;

    public BiomeProviderLM()
    {
        this.biomeCache = new BiomeCache(this);
    }

    public BiomeProviderLM(long seed)
    {
        this();
        GenLayer[] agenlayer = GenLayerFixLM.createWorld(seed);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderLM(World world)
    {
        this(world.getSeed());
    }
